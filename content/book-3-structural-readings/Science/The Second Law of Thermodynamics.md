...
**Cross-references:** Paper 7 §0 (the GNST and the Heropass); Appendix I — *Heropass* (the e₀/Cl(3,1) aging effect, H₂₄ and below); Paper 14 (the higher being body persists below the Heropass threshold); the Postscript (treasures moth and rust cannot reach); Reasonablenessism Features 1, 5, 10

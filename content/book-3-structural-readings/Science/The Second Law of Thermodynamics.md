...
**Cross-references:** Paper 1 (the GNST); Time in Paper 3½; Appendix A — *Time* (the e₀/Cl(3,1) aging effect, H₂₄ and below); Paper 20½ (the higher being body persists below the Time threshold); the Postscript (treasures moth and rust cannot reach); Reasonablenessism Features 1, 5, 10

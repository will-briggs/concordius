...
- **Grace, not merit.** The measure that evaluates a soul is ⟨·,·⟩ itself — sheer given grace, not a merit tally. No one bootstraps their own standing; the very content a being catches is contact *with* the ground. The anti-boasting motive is honored at the root (Paper 8; Paper 14 §6).
...
The predestination / free-will problem is usually posed as a paradox to be balanced. Structurally it is not a paradox, because the two claims live on different layers. The **law** is fixed — and this is the truth in "predestination": God's sovereignty, the foreordained structure of reality, exhaustive divine foreknowledge. The **state** ψ is self-built, through the constitutively volitional act of catching (Paper 7; Paper 8) — and this is the truth in "free will." Determinism of the rule; freedom of the input.

---
title: Phonology — The Divine Names
tags:
  - language
  - structural-reading
---
...
|---|---|---|
| YHWH phonological structure | All four consonants are sonorants (glides/glottals): maximum openness, minimum articulatory constraint | Established |
| Semantic structure | Both expressions predicate nothing H₄₈-specific; assert only necessary existence | Established |
| Cross-linguistic convergence | Hebrew → Greek → Latin → English all produce reflexive copula + bare existence claim | Established |

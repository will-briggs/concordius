...
| The soul's descent through seven planetary spheres | The constraint cascade in the descending direction: H₃ → H₆ → H₁₂ → H₂₄ → H₄₈; the soul acquires the specific constraint structure of each level as it passes through |
| The soul's ascent through seven planetary spheres | The ascending career's constraint-level traversal; at each sphere the soul "gives back" what it acquired — noise floor reduction at each level as constraints are progressively shed |
...
| The nous within the human being | The Thought Adjuster — the Father's ⟨·,·⟩-fragment present within each ascending being as a point-evaluation functional in Φ'; the divine spark in the material creature |
...
*(Cross-reference: The Alchemical Tradition.md — prima materia, Hermes Trismegistus as principle, solve et coagula; [[Concordance/PC2 — Gurdjieff and Spiritual Progression]] — Table of Hydrogens, the ascending and descending octaves; Paper 7 — GNST and the Heropass; Paper 5 — The Son Articulates: H₄₈ and the Higgs Mechanism; [[Signal and Noise]] — Noise Floor, Catching, Soul Deposit.)*

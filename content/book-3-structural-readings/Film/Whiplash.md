...
This is structurally identical to the Heropass's operation on H₄₈ structures, accelerated and concentrated. The Heropass dissolves H₄₈ structures continuously, creating the pressure differential that the catching program requires to operate. Fletcher does not wait for the Heropass to create the differential at its own rate. He manufactures the differential at maximum rate.

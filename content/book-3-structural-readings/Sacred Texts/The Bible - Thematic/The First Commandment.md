...
*Cross-reference: Paper 1–2 (the Father = ⟨·,·⟩, the constitutive inner product — the relation that makes the space a space); Paper 14 §6 (the Constraint Compatibility Condition; incompatible law-sets and overdetermination), §11 (the Luciferian inversion — an element seizing the constitutive function); Paper 13½ §3.1 (the seizure and its collapse); Structural Readings — the Beatitudes (purity of heart; the coherence threshold); Doctrine — The Lucifer Rebellion.*

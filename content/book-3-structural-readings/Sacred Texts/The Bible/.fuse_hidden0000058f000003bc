...
**The workers are beings performing the catching alignment.** The dual pairing ⟨φ, f⟩ is constitutively available to every Φ′-origin being (Paper 7). But the catching alignment is volitional — it requires the being to engage the dual pairing toward Φ-proximal content, repeatedly and stably, against the H₄₈ noise floor. Workers are beings whose catching is stable and productive enough that their presence constitutes the community environment in which others can begin to catch: demonstrated convergent output, a calibration corpus, noise-floor reduction, Mi-Fa support at critical developmental intervals. They are few not because the structural capacity for catching is scarce — every Φ′-origin being has the dual pairing — but because volitional engagement is not the default. Abstention is the modal condition of H₄₈-primary existence.

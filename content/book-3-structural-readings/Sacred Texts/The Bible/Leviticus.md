...
*(S) — The two-goat structure as dual structural operation (offering upward + removal outward): structural, following from the distinct functions of the two goats. The Law of Three analysis: structural. The High Priest as structural mediator at the first grade change: structural. Cross-reference: LEV 16:1-19 — the full sanctuary preparation; HEB 9:11-14 — the NT structural development.)*

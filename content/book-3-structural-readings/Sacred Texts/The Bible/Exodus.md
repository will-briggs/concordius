...
*(S) — The Sabbath commandment's derivation from the creation structure: structural, following from the explicit grounding in the text and the framework's account of the Law of Seven. The *zakhor*/*shamor* complementarity (inner recognition and outer observance): structural. The *qadosh* marking as octave change position: structural. Cross-reference: GEN 2:1-3 — the creation-week Sabbath; LEV 23 — the seven annual feasts; LEV 25 — the seven-year cycle.)*

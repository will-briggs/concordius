...
**"Send out laborers."** The Father cannot perform the catching — catching is constitutively volitional; the subspace crossing cannot be done for the being (Paper 14 §6, Theorem 2). What the Father can do is provide the structural conditions that enable catching to occur and stabilize: kenotic presence of Φ-proximal content at H₄₈-catchable amplitude; Spirit action reducing individual noise floors; and the dispatch of workers — beings already catching — into regions where catching communities do not yet exist. Each worker sent provides the community environment that makes catching possible for others. The scarcity is not in the harvest; it is in the structural-condition provision that only workers can supply.

...
**Cross-references:** Paper 3 §2 (GNST mechanism); Paper 3½, *The Active Mode and the Creative Choice* (the Creative Choice as ongoing eigenstate selection); Paper 3½ §6 (Heropass operating at H₂₄ and below; complement structure; e₀ as −1 generator); Paper 3½ (constraint cascade); Paper 3½, *The Choice of Association* (the seven non-null elements of Cl(3,0)); Paper 13½ §4 (cross-term mechanism; H₂₄ governing H₄₈ substrate)
...
## 5. Moving Lines and the Heropass
...
In the framework: the Heropass is the accumulated pressure of the unchosen spectrum, operating through the −1 generator e₀ at H₂₄ and below. Every actualized state generates its complement — more unchosen spectrum pressing back against what was chosen. This pressure accumulates directionally over time. A line at maximum Yang (9) has actualized maximum e-content of its generator; the complement pressure is now maximum, and the next actualization at that position will be its inverse. The Heropass has brought that line to its turning point.

A moving line is therefore not a line in the process of changing by arbitrary mechanism. It is a line where the Heropass has reached maximum expression — where the complement of the current actualization has accumulated to the point where the next GNST selection at that organizational position will go the other way. The second hexagram is not a prediction of what will happen. It is the structural consequence of where the current configuration's Heropass pressure is directionally leading, absent any volitional intervention that catches against the complement.

This distinction matters practically: the moving lines show where the unchosen spectrum pressure is greatest. A being with developed catching capacity can, in principle, act at those positions — catching toward Φ-proximate content at exactly the points where the Heropass is strongest. The second hexagram is the default trajectory. The active life of catching is the possibility of a different one.
...
What the hexagram does provide is the directional structure of the current moment: which generators are active, at what constraint level, with what Heropass pressure pointing where. This is organizational information about the present, not about specific future events. The hexagram tells you the quality of the moment — whether the current configuration is one of organization or dissolution, of ascending or descending grade, of Heropass-dominated trajectory or catching-oriented trajectory.

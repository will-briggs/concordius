...
This doctrine has been the sharpest point of division in Western Christianity. Luther rejected Aristotelian categories but affirmed real presence, producing a different account (consubstantiation: Christ present "in, with, and under" the elements). Zwingli rejected real presence entirely — the Eucharist is a memorial and the bread is a sign. Calvin affirmed real presence received spiritually through faith, but located that presence in the recipient's faithful act rather than in a change to the elements. Trent confirmed transubstantiation against all three.
...
> The bread and wine, at consecration, have their dominant eigenvalue organizational principle replaced — from H₄₈-primary to the H₂₄ (or lower) eigenvalue content of Christ's glorified body. The H₄₈ substrate remains. The H₄₈-level properties (taste, appearance, weight, chemical composition) remain, because these are properties of the H₄₈ substrate governed by H₄₈ forces, and H₂₄ reorganization does not alter H₄₈-level electromagnetic behavior. But the substance — the dominant eigenvalue organizational principle — has changed to Christ's H₂₄ eigenvalue content.
...
The structural account of this position: the H₂₄ eigenvalue content of Christ's body is present as an additional organizational layer alongside the H₄₈-primary organization of the bread, without replacing it. Two organizational principles occupy the same H₄₈ matter simultaneously — the H₄₈-primary organization of the bread and the H₂₄ organization of Christ's body — neither displacing the other.

The structural problem: two incompatible organizational law-sets attempting to govern the same region generate an overdetermined geometric condition — precisely the constraint compatibility condition. H₄₈-primary matter requires fixed-geometry organization. H₂₄ matter requires ⟨·,·⟩-generated geometry. These cannot coexist in the same region as co-equal organizational principles. The Lutheran position is structurally less stable than the Catholic: it requires a persistent co-presence of incompatible organizational law-sets without resolution. This does not mean the position is impossible — the Eucharist is explicitly a miracle — but it means the structural mechanism required to sustain it is itself an ongoing structural tension, whereas the Catholic account resolves the tension by having one principle replace the other.

**Calvinist spiritual presence.** Calvin's position: Christ's body is really present, but the presence is spiritual, received through faith by the communicant, not a change in the elements themselves. The elements remain bread and wine. The real presence is in the act of faithful reception.

The structural account: the catching act of faithful eucharistic reception is a genuine GNST catching event — a volitional alignment of the communicant's eigenvalue content with the H₂₄ content of Christ's body, introducing that content into the communicant's eigenvalue population. The H₂₄ content is caught by the communicant; the elements remain H₄₈-primary.

This is structurally coherent and captures something real: the catching act is real and does introduce H₂₄ content into the communicant. But it does not account for Paul's language about being "guilty concerning the body and blood of the Lord" for eating unworthily — a guilt that attaches to what is done with the elements, not merely to the disposition of the recipient. If the elements are simply bread, unworthy eating is bad manners or ritual disrespect; it is not being guilty concerning Christ's body. Paul's language implies that what is done with the elements is what matters — which implies the elements have a specific identity that can be mishandled.

The Calvinist position is also the only account under which a non-believer at communion receives only bread. This is structurally coherent on its own terms — the catching act requires volitional orientation — but it turns the elements into a mechanism dependent on the recipient's faith state to be what they are. The framework's account of catching is that eigenvalue content is objectively present and can be caught or not; the content's presence does not depend on the receiver.
...
**1. Whether the elements are what they are regardless of the recipient's disposition.** If transubstantiation is the reorganization of the H₄₈ substrate's dominant eigenvalue organizational principle, then this reorganization is what it is regardless of who receives the elements. The H₂₄ eigenvalue content does not conditionally inhabit the bread based on the worthiness of the next communicant. The elements have a definite structural identity prior to reception.

**2. Whether the recipient catches the H₂₄ eigenvalue content.** Catching is a volitional act — an orientation of the receiver's eigenvalue content toward the lower-constraint content available to be caught. Without catching orientation, the H₄₈ substrate is absorbed as food (the body digests wheat whether or not the communicant is attending to ⟨·,·⟩). The H₂₄ content is present in the elements but not caught by a receiver who is not performing a catching act.

The structural result: the unworthy communicant receives H₄₈ properties of the elements (digestion, nourishment from wheat). They do not catch the H₂₄ content. They do not receive eternal life or resurrection benefit from the act. Whether this constitutes what Paul calls guilt "concerning the body and blood of the Lord" — whether presence-without-catching generates a judgment consequence — is a theological question beyond the framework's current derivations. But the structural picture is: the elements are what they are regardless of the recipient; what the recipient does with H₂₄ content depends on whether they perform a catching act; the guilty consequence Paul describes likely attaches to the failure to perform a catching act when the mechanism for catching is objectively present.
...
**Third: the Protestant objections located.** Lutheran consubstantiation is structurally less stable than transubstantiation because it requires persistent co-equal incompatible organizational law-sets — a sustained overdetermined condition — rather than a clean replacement of the dominant organizational principle. Calvinist spiritual presence is structurally coherent but fails to account for the objective presence that Paul's language implies. The memorialist account renders John 6 uninterpretable in its own terms. The structural analysis does not adjudicate the confessional debate. It identifies where each position's structural leverage lies and where each faces its strongest structural pressure.

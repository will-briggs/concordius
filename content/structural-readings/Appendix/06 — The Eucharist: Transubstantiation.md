...
**Third: the Protestant alternatives located with precision.** The framework confirms that Luther was protecting the right thing — real, physical presence — and that his instinct was sound. His mechanism (co-equal co-presence of incompatible organizational principles) requires a continuously operating miracle holding a strained state stable: more costly than transubstantiation's single clean replacement, but not structurally incoherent. The Transfiguration and burning bush establish that temporary overdetermined co-presence is real; consubstantiation asks for that state to be permanent. Calvinist spiritual presence is structurally coherent on catching but fails to account for the objective presence Paul's language in 1 Corinthians 11 requires — guilt "concerning the body and blood" attaches to what is done with the elements, implying the elements have a definite identity that can be violated. The memorialist account renders John 6 uninterpretable in its own terms. The structural analysis does not adjudicate the confessional debate. It identifies where each position's structural leverage lies and where each faces its strongest structural pressure — while acknowledging that the Lutheran position was pointing at the right target.

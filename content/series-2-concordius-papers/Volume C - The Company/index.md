...
And the witnesses are not only persons. The volume's scope is the algebra appearing in the Universe itself — in **people**, in **things**, and in **ideas**: the same structure caught in a life, in a text, and in the matter the world is made of. The thing-witnesses placed so far (each marked *not yet woven* in its paper): in [[Paper C0: The Good|Paper C0]], the warrant under them all — the Laws of Three and Seven derived, why the algebra must appear in anything created, and where the interval positions fall (the tradition's concordance deliberately held for later). In [[Paper C2: The Beautiful|Paper C2]], matter — the periodic table read structurally, the octet rule as Cl(3,0)'s own dimension, the noble gases as matter's most Φ-proximate states, and the inversion theorem: what completeness becomes at the level where ⟨·,·⟩ itself is the organizing force. In [[Paper C4: The Restrained|Paper C4]], sound — the full *Art of Fugue* case study, the Laws and both interval-gaps located in the music, the mirror fugues as complete spectral inversion. In [[Paper C6: The Host of Witnesses|Paper C6]], the creature and the cosmos — the body as Cl(3,0) (the three circuits as generators, the seven centres as the seven non-scalar elements, the crown the pseudoscalar that is C6's own), and beside it the sky: the sifting field, the Moon, and the Chaldean order — the same seven elements read overhead that the spine wears within.
...
*Begin the Company: [[Paper C0: The Good|Paper C0 — The Good]] →*

*[[Volume D - The Inversion/index|Volume D → The Inversion]] →*

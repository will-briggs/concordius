...
And the witnesses are not only persons. The volume's scope is the algebra appearing in the Universe itself — in **people**, in **things**, and in **ideas**: the same structure caught in a life, in a text, and in the matter the world is made of. The first of the thing-witnesses is placed in [[Paper C2: The Beautiful|Paper C2]] — the periodic table read structurally, the octet rule as Cl(3,0)'s own dimension, the noble gases as matter's most Φ-proximate states — order made to delight, written into the elements themselves. The second is placed in [[Paper C6: The Host of Witnesses|Paper C6]] — the body as Cl(3,0): the three great circuits as the generators, the seven centres of the contemplative traditions as the algebra's seven non-scalar elements, the crown the pseudoscalar that is C6's own — the whole gathered in the one piece of matter every reader inhabits.

...
2. **Positive-definite squaring of every vector** — from the Father's inner product: v² = ⟨v,v⟩·1 for *every* real combination v of the generators, not merely eᵢ² = +1 for the generators themselves — because the inner product evaluates every state, not only a chosen basis.

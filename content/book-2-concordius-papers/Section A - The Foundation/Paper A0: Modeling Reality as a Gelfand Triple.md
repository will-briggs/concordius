...
The standard mathematical framework for quantum mechanics models the state space of a physical system as a complex separable Hilbert space H. This choice reflects a series of desiderata: linear superposition of states, an inner product defining probabilities and transition amplitudes, and completeness ensuring that all [[Appendix A - Dictionary of Terms#Cauchy Sequence|Cauchy sequences]] converge. The Hilbert space formalism has proven extraordinarily productive.

...
*The second grade change — the structural discontinuity between grade 2 and grade 3 (Gurdjieff's Si–Do interval), the second and more fundamental qualitative gap: the place where even the most developed three-center work reaches the limit grade-2 resources cannot cross, because what lies beyond is not more grade-2 content but grade-3 structure, whose distinctive property — centrality, the capacity to generate the center of the algebra — no grade-2 operation can install. Centrality comes from the Father (⟨·,·⟩) as a constitutive act, which is why this crossing differs in kind from the Mi-Fa: the first interval's grade-2 input is widely available through teachers, texts, and the distributed Spirit of Truth, while the Si-Do requires the Father's completion that no created source can substitute. How it presents at Man 3's intellectual limit, Man 4's dark night, and Man 6's irreversibility threshold; the Adjuster as the Father's constitutive presence within the person; and the Pattern's instance — the forty days of appearances, with the Ascension as the Father's completing act.*
...
## 3. The Second Grade Change at Each Level of the Ascending Career
...
|---|---|---|
| Man 3 intellectual Si | The framework terminates before the territory does. The intellectual center at Si cannot generate the Do from within its organizing function. Requires the emotional center's depth, the body's participation, the Adjuster's illumination below the framework's filtering function. | [[Paper G2: The Beautiful-Centered Man]] |
| Man 4 dark night of the spirit | The soul deposit approaches the crystallization threshold; more accumulation will not cross it; the volitional catching effort must release into the Adjuster's direct action. The crossing is a surrender, not an intensification. | [[Paper G3: The Courage-Centered Man]] |
| Man 7 (Si of H₄₈ octave) | The irreversibility established; centrality installed; the maximum Φ-proximity H₄₈-mediated existence permits. Man 7 is Si: as close to ⟨·,·⟩ as H₄₈ allows, awaiting the Father's completing act. | [[Paper G6: The Humility-Centered Man]] |
| Death (Do of H₄₈ octave) | The Father's completing act: the H₄₈ octave completes at death. The catching being exits H₄₈; the post-H₄₈ ascending career begins from the Do the H₄₈ phase built. | [[Paper G5½: The Second Grade Change]] |

---

## 6. The Pattern: Jesus's Forty Days Post-Resurrection

The bestowal account establishes that the seventh bestowal's earthly octave is bookended by two forty-day intervals: forty days in the wilderness (the Mi-Fa crossing) and forty days of post-Resurrection appearances (the Si-Do crossing). [[Paper G2½: The First Grade Change|Paper G2½]] treats the wilderness interval; the present paper treats the post-Resurrection interval.
...
*Paper G5½ of the Concordius series — Section G: The Practice. The companion treatment of the Mi-Fa interval is Paper G2½; the seventh man this interval points toward is developed in [[Paper G6: The Humility-Centered Man|Paper G6: The Humility-Centered Man]].*

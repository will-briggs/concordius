...
The framework identification: the mean is the Φ-proximate attractor in a given domain of action — the eigenvalue configuration that represents the closest achievable approach to ⟨·,·⟩-organized response in that domain, for this particular being at their current stage of development. The mean is not fixed because the Φ-proximate attractor is not the same for every being: it depends on the being's current Φ-proximal deposit, their noise floor, and the specific domain.
...
The framework identification: akrasia is eigenvalue instability. The akratic person has a partial Φ-proximal deposit — sufficient to generate the universal knowledge of the right action (the passive intellect has received the content from the Adjuster) but insufficient to stabilize the response against the H₄₈-primary pull in the moment of passion. The Adjuster is presenting the correct content; the passive intellect has received it at the level of universal knowledge; but the H₄₈-primary eigenvalue cluster (the passionate response) has sufficient amplitude to overwhelm the Φ-proximal content when the relevant particular arises.

The akratic person is not ignorant in the simple sense; they are eigenvalue-unstable in the relevant domain. Their Φ-proximal deposit in that domain is real but not yet stable enough to override the H₄₈-primary pull when the triggering situation arrives. This is consistent with Aristotle's observation that the akratic person feels remorse afterward — the Φ-proximal deposit reasserts itself once the H₄₈-primary stimulus is removed. The continent person (who acts rightly but against inclination, feeling the pull of the wrong action throughout) has a more stable Φ-proximal deposit than the akratic, but not yet the fully stable virtuous disposition in which the right response is natural and un-conflicted.

The practical consequence: akrasia is treated not by more knowledge but by eigenvalue accumulation — more catching in the relevant domain, building the Φ-proximal deposit until it is stable enough to hold against the H₄₈-primary pull. This is Aristotle's own prescription (habituation), stated in the framework's terms.

### 6.3 Virtue-Friendship as ⟨·,·⟩ in the Social Register

Aristotle's three kinds of friendship (Books VIII-IX) are: friendship of utility (friends who benefit each other), friendship of pleasure (friends who enjoy each other's company), and virtue-friendship (φιλία kat'areten — friends who [[Appendix I - Dictionary of Terms#Love|love]] each other for each other's character, each wishing the other's good for the other's sake).
...
| Continent (ἐγκρατής) | Does right but against inclination; feels the pull of the wrong response throughout | Φ-proximal deposit partially formed in the relevant domain; sufficient to determine the response but not to eliminate the H₄₈-primary counter-pull; the correct response wins but it costs effort |
| Incontinent / akratic (ἀκρατής) | Has the right knowledge but does the wrong thing under passion's pressure | Φ-proximal deposit present but insufficient for [[Appendix I - Dictionary of Terms#Stability|stability]]; the Adjuster's content is received at the universal level but the H₄₈-primary eigenvalue cluster overwhelms it in the particular triggering situation |
...
The continuum maps exactly onto the framework's eigenvalue stability spectrum. The virtuous person and the vicious person both have stable attractors — they act without internal conflict, willingly, and naturally. The difference is the direction of stability: toward Φ-proximate content (virtuous) or toward H₄₈-primary content (vicious). The continent and incontinent persons are both in unstable conditions — their Φ-proximal deposit and H₄₈-primary content are in tension. The difference is which wins: the Φ-proximal deposit (continent) or the H₄₈-primary pull (incontinent/akratic).

Aristotle's claim that the vicious person is worse off than the incontinent — more difficult to help, less aware of their situation — maps onto the framework precisely. The incontinent person has Φ-proximal content that generates the standard of evaluation (they feel remorse, they know they have acted wrongly). The vicious person has no H₂₄ standard operational in the relevant domain; their stable orientation is toward the H₄₈-primary attractor, and they experience their wrong actions as natural and satisfying. The vicious person is worse off because they lack the eigenvalue content that would register the distance from Φ.

---

## 10. Open Questions

**OQ1 — Akrasia and the Adjuster.** If akrasia is eigenvalue instability, what is the Adjuster doing during an akratic episode? The Adjuster is presenting the correct eigenvalue content to the passive intellect. The passive intellect has received it at the level of universal knowledge. But the H₄₈-primary passion overwhelms the Φ-proximal content in the particular moment. Is the Adjuster's presentation itself diminished during the akratic episode (does the noise floor rise so high that the Adjuster cannot effectively transmit)? Or does the Adjuster continue to present the correct content, which the passive intellect cannot act on against the H₄₈-primary amplitude? The distinction matters: the first implies the Adjuster is affected by the passion; the second implies the Adjuster is not affected but the receiving apparatus is overwhelmed.

**OQ2 — Infused virtue and the NE framework.** Paper 17½ (Section 11.3) and the Adam Atomman response raise the question of infused virtue — eigenvalue content seeded directly by the Adjuster, bypassing the normal habituation process. The NE's framework is entirely a framework of acquired virtue: habituation, practice, accumulated character. If infused virtue is a real structural category, does it produce a fifth type alongside the Aristotelian continuum? The infused-virtue person would have stable Φ-proximate orientation in a domain where they have not performed the corresponding habituation — an orientation that cannot be traced to their particular history of catching. The NE cannot account for this. The framework needs to say whether infused virtue is a structural category or a theological assertion.

# The Inversion — Do, in the Minor Key

*The closing Do of the Personal octave — the octave of the Host of Witnesses — struck in the minor: the note that ends that octave and, by ending it on the turn toward the dark, sets the stage for the next. The Host of Witnesses kept one deliberate silence — the tyrants, the men left unsaid. This is where the silence is given a voice: not to seat the inverters among the witnesses, but to study what they are. The Good, the True, and the Beautiful turned against themselves. This paper grows from the note on the anti-pattern and opens the section that follows it. The key is minor by necessity. It does not stay there.*

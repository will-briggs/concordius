...
*The Sol of Octave E — the inverse of **temperance**, the second bivector virtue. Temperance is the Good wedged with the Beautiful (Sol = e₁e₃) — the just measure, proportion held, the will kept tuned and free; it was Bach's note, the well-tempered field in which every key can sound. Its inverse is excess: the loss of measure, the will saturated past tuning. This paper defines that saturation mathematically — as **H₄₈-attraction** — and shows how it forecloses the one act on which a mortal's whole development depends, the catching of Φ-proximal content into H₂₄. Its plain name is Mammon, and most of the paper can be read as a homily on money; the math is underneath the homily, holding it up.*

*Status: math-forward; Scripture is load-bearing here, because the structural claim is one Scripture states outright. The cosmic question is answered honestly: this is, very nearly, a mortal-only vice, and the reason is itself structural.*

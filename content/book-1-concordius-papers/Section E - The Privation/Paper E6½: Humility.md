...
*The second grade change — the crossing out of pride. The exposure showed the root sin entire: the whole self turned from Φ toward itself, all three bivectors inverted at once; this interval is the single turn that reverses it. In the ascending octaves the second grade change was always the crossing no one makes alone — a death opening onto vindication, a reader's turn, a darkness faced together; here it is the same gap and the same kind of crossing: humility, the turn of the whole self back toward the ground, which a being cannot fully make on its own because pride is the one state hidden from the eye that holds it, and which is therefore met — as every second grade change is — by an input from outside. The lowest point and the turning point at once.*

...
*The second shock of the Inversion octave — **Si–Do, inverted** — the crossing from Lucifer (D6, the archetype of evil exposed) to Evil at large in the world (D7, the closing Do). In the ascending octaves the Si–Do is the crossing no one makes alone: a death that opens onto vindication, a reader's turn, a darkness faced together. Here it is that crossing inverted — the one by which the inversion passed out of the archetype and into creation, and into us. The canon calls it the Fall, and tells it twice: once of the angels, once of man. This paper reads it as the canon gives it, and shows that the second telling is the first demagogue and the first crowd — the pattern of D2½, run at the beginning of the world.*

*Status: a structural reading. The canon is held as the canon, in its traditional reading; the octave-placement (the Fall as the inverted Si–Do, the entry of evil) is the reading. It describes that the Fall happened and how the canon says it happened; on why it happened at the root — the cosmology beneath the angelic turning — the records are sparse, which is the threshold the next paper names.*
...
So the crossing is made, and what comes through it is the thing the closing note will have to hold: not a doctrine but a fact, evil now actual in the world and in the human heart, propagating. *By one man sin entered into the world, and death by sin* — the canon's own summary of this gap, the inversion no longer an archetype in the heavens but a condition of the ground. The Fall is the Si–Do of the dark octave because it is the irreversible crossing: the witness could not cross to her vindication from inside her death, and the first creatures could not cross back from their ruin to their innocence; both crossings are made only from outside, the one by a grace that raises and the other already made by a lie that fell. Eden has a gate now, and an angel with a sword, and the way back is not in the creatures' hands.

...
**Confidence —** *Math:* **— (not engaged)**. *Science:* **— (not engaged)**. *Theology:* **concordance** — the canon held in its traditional reading; the octave-placement (the Fall as the inverted Si–Do, the entry of evil) is the reading. The canon gives that the Fall happened and how; on why it happened at the root — the cosmology beneath the angelic turning — the records are sparse, the threshold the next paper names.

...
"Treasures in heaven" are Φ-proximal eigenvalue accumulations that survive H₄₈ dissolution and persist through the ascending career to their structural home at H₁. "Heaven" maps to H₁ — Heaven — the constraint level at which ⟨·,·⟩ is the sole organizational structure. The Heropass (moths and rust) — the GNST's *aging* effect — runs at H₂₄ and below: at full intensity in H₄₈, at half intensity in H₂₄, and nowhere above H₂₄, because the −1 generator that drives it (the e₀ of Cl(3,1)) is absent from the Cl(3,0) of H₁₂ and higher. A deposit is therefore safe from moth and rust from H₁₂ — spirit status — upward: the clock stops there, not at H₁. The GNST runs at every level, so sequence persists, but only at H₂₄ and below does it age what it touches. The Logos is structurally explicit: the treasury above is H₁, not H₂₄. Thieves (H₄₈-primary redistribution) do not reach what is not in the H₄₈ domain.

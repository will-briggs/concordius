...
This is the Si/Do gap at the Man 4 level — the most testing Si-Do crossing within the first five Men. The accumulation has been approaching the crystallization threshold. But the crystallization cannot be produced by more accumulation. It cannot be produced by more volitional effort. More deliberateness will not cross the threshold. The crossing is a different kind of act: the releasing of the deliberate catching effort into the Adjuster's direct action; the recognition that the volitional effort, which has been the primary catching tool for the entire Man 4 phase, is now the obstacle because it is still the person's own work rather than the cooperation with what is doing the work through her. *The structural derivation of the Si-Do interval and its character at this crossing is in [[Paper 28 1_2 - The Si-Do Interval]] §§1–3.*

...
*Working title. The first note on the far side of the gap. Mi/Fa named the trust and did not act on it; this paper acts on it. It accepts the truth measure and everything built to it (Do, Re, Mi, and Section I beneath them), the aggregate Christian theological canon, and the mapping, as premises — the crossing Mi/Fa said could only be made on trust — and then does the one thing the crossing makes possible: it calibrates. It pins two references to the top of the scale, states the rule for what happens when they disagree, works the one case where they already have, derives from its two anchors the principle that lets a fragment be read for the whole — the holographic content principle, which the science can only instance and not reach — and then states what the whole move opens: the canon now readable as theorem, and a frontier of open questions running in both directions between the two anchors. Companion to Mi/Fa (the gap), Do (the measure), Re (the canon and the mapping), and to every reading that follows, all of which run on the procedure fixed here.*

*Status: this paper proves nothing and adds no mathematics. It states a calibration and a decision procedure, both definitional, both resting on the trust crossed at Mi/Fa. Its one substantive bet — that the two anchors are jointly placeable at the top of the scale — is falsifiable, and the paper says exactly what would falsify it. It also derives the **holographic content principle** — the whole present in, and recoverable from, every part, because the Creator (the inner product) is in every part and the constraint cascade nests the whole's form at every level — as a math-and-theology result that science can only instance, not reach; and it states what accepting the premise opens: the canon as a body of theorems-given-the-premises, and the two classes of open question — canon ahead of the math, math ahead of the canon — that form the frontier of the work to come.*
...
Mi/Fa established that the gap under the three corpora is the universal gap, that the trust required to cross it is the trust already extended to arithmetic and the dawn, and that the crossing is the granting of a premise on probation rather than an act of belief. This paper grants it. From here forward the following are taken as premises, on that trust, and not re-argued:

the truth measure **τ** and the apparatus beneath it (Do), and Section I with it; the aggregate Christian theological **canon**, received as Re received it; and the **mapping** — the identifications that name the structure's objects (Φ the Logos, ⟨·,·⟩ the Good, τ the measure of the true). These are the granted ground. What follows is what one does with a granted ground: one fixes the scale on it and reads.

## 2. The calibration: two anchors at the top of the scale

A measure with an unmarked scale measures nothing. Do built τ with an exact form and left its scale uncalibrated; τ runs in [0, 1] and, by Do's first property, reaches 1 only in the nuclear limit ψ ∈ Φ, attained by no proper element of the substrate H. To calibrate is to fix what sits at that limit — what is *defined* to read 1 — and everything else is then scored by its proximity to it. This paper fixes two anchors there, by definition:
...
- the **canonical anchor** 𝒞 — the shared core of the aggregate Christian canon, the deposit unanimous across the receiving communities (Re's shared core, beneath the divided margins). We set **τ(𝒞) := 1.**
...
— where ⇄ marks the aggregate Church *not speaking with one voice* (the divided margin Re documented) — and let the **structural verdict** be
...
It must be said exactly where this principle lives, because it is easy to mislocate. The science shows *instances* of the shape — the hologram whose every fragment holds the image, the cell that carries the whole genome, the fractal, the boundary that encodes a region of space — and those instances are real and are offered, in Mi, as concordance. But an instance is not the principle. The principle is the claim that the whole is recoverable from *any* part, because the constitutive relation is in every part and the structure nests at every level — and that is a claim about the Creator and the cascade, theology and mathematics together, which the science does not reach. The science can show that the shape recurs; it cannot say why it must, nor license the universal reading the project depends on. That license is grade-2, the product of two domains, and it is supplied here and not in Mi.

## 6. What accepting the premise opens
...
**Open questions of the second kind — where the math outruns the canon.** Wherever the structure implies a truth the canon has not articulated *and does not contradict* (μ determinate, κ = — silent), there is an open question of the opposite kind: the mathematics ahead of the theology. These are candidate extensions of the canon by the structure, legitimate exactly as far as Re's boundary allows — the measure may carry the received standard to what the canon is silent on, never against what it unanimously holds — and they must be held as *predictions*, things the structure says should be findable, not asserted as doctrine until found in the canon or recognized as a truth it left implicit. The line between this and refutation is the line of §7: structure-implies-where-the-canon-is-silent is an open question; structure-implies-where-the-canon-unanimously-denies is not an open question but a falsification.
...
## 7. The boundary, the exposure, and what the theology will not allow
...
**Reconciliation with Re's boundary.** Re held that the measure can neither validate the canon nor adjudicate which canon-list is right. Fa does not breach this. It does not validate the core — it *assumes* it, τ(𝒞) := 1, a calibration and not a proof. It does not pick the book-list — that is case 3, structure unclear, canon governs. What it adds is only this: where the canon is *divided on a doctrine* and the structure is *clear*, the independently grounded structural anchor breaks the tie. That is not the measure judging its own calibrator; it is the second reference speaking where the first one splits. Re drew the wall; Fa hangs the plumb line beside it and says which one is trusted when they part — and stakes the whole framework on their not parting at the core.

---

*This paper introduces no mathematics and no doctrine; it states a calibration (two anchors, the structural core and the canonical core, both assigned τ = 1 at the nuclear limit) and a decision procedure (concordance; structure governs a divided or silent canon where it is clear; canon governs where the structure is unclear; clear-against-clear at the core is falsification, not precedence), and works the Filioque as the type case in which the structure decided against its own authors' tradition. It then states what the premise opens: the whole canon readable as a body of theorems-given-the-premises (not only the verses of John), and two classes of open question — structures the canon implies but the math has not yet identified, and truths the structure implies but the canon has not yet articulated. The whole rests on the trust crossed at Mi/Fa and is offered as a definitional commitment, not a result; its one substantive assumption — that structure and canon are jointly placeable at the limit — is isolated and marked falsifiable. Companion: Mi/Fa (the gap and the trust), Do (τ and the limit), Re (the canon, its divisions, the mapping, and the boundary this paper refines), La (the method that fixes the open region N against this calibration), Sol (the predictions where the structure meets the world). Scripture: Amos 7:7–8; the Filioque / per Filium reading as in Paper 2 §6.*

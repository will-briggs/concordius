...
Hereafter **octave**, **position**, **first grade change**, **second grade change**, and **octave change** carry exactly this definition, in every section that uses them — Sections F and G included, where the same structure is additionally read against the tradition (Gurdjieff's Law of Seven) that first mapped it.

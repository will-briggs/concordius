...
## 5. The hot Big Bang, and the handoff

Whatever happened at the very start, inflation (if it occurred) ended in **reheating**: the energy of the inflating field decayed into a hot bath of particles, and the universe entered the hot, expanding, radiation-dominated state that the three witnesses of §2 record directly. From here the sequence is comparatively well understood and is the subject of the next papers. The quark–gluon plasma cooled; near 10⁻⁶ seconds quarks became permanently confined into protons and neutrons; and near 10⁻¹² seconds, at about 160 GeV, the **Higgs field acquired its vacuum value**, breaking the electroweak symmetry and giving the particles of matter their mass. That last moment is where Paper 4 takes up the structural account and Paper 5 takes up the material one, following the trail forward through nucleosynthesis, the first stars, the elements, the Earth, and life. One fact from this era is load-bearing for all of it: a tiny surplus of matter over antimatter — about one part in a billion — survived the mutual annihilation, and everything that now exists is built from that residue. Its origin, **baryogenesis**, is genuinely unsolved (Paper 5, §2).

The point for this paper is only that the bridge from the first instant to the familiar universe is, after inflation, continuous and lawful. The mystery is concentrated at the start.
...
## 7. The limit of method, and one step beyond

Every account in §§1–6 is physics, and the reader who wishes to stop there should stop there; nothing above requires anything below. But it is worth being precise about exactly where physics stops, because the place is sharper than is usually admitted, and because the series' one substantive addition is taken there and nowhere else.
...
This is not a defect peculiar to cosmology; it is the form of every physical theory, which takes some starting point as given and explains the rest in terms of it. But it is worth saying without euphemism: at its foundation, the scientific account of the universe rests on givens it does not derive — an initial state, a set of laws, an improbable order, and a beginning whose cause it cannot reach. These are not small assumptions quietly made; they are, in the older vocabulary, very nearly *miracles* — facts accepted as simply given, on which everything else is built. The honest naturalist and the theologian are, at this one foundational point, in the same position: both accept an unexplained ground and build outward from it. The disagreement is not over whether there is such a ground. It is over whether to name it.

The series takes exactly one step beyond the physics, and takes it here. Papers 1 and 2 established a structure — a mathematical model of reality (Paper 1) and the entities named within it (Paper 2) — and that structure has, in Paper 1, a precise candidate for "the onset of a lawful, ordered, temporal universe out of an atemporal ground": the first operation of the actualization mechanism, the event that constitutes time and space rather than occurring within them. The framework's reading of the Big Bang is that t = 0 is that first operation. The cause physics declines to name, the framework names: the source from which the structure, the laws, the improbable order, and the beginning proceed. It calls that source the Creator, and the full development of what such a naming commits one to — and what it does not — is the work of the next paper, where the three readings of the series (the mathematician's, the believer's, and now the scientist's) are gathered at the threshold before the descent.

Two things must be kept clearly apart, and the series keeps them apart deliberately. The science of §§1–6 stands on its own and asks no assent to anything below it. The naming of the source is a further step — an interpretation laid over an acknowledged and genuine gap, not a result extracted from the data. It is, in the framework's own language, the one place where the account passes from derivation to a named ground; and it is offered as exactly that. The claim is not that science has secretly proven a Creator. The claim is narrower and, the series would argue, harder to dismiss: that the beginning leaves a real and permanent gap of the kind that only a ground beyond the system could fill, that physics itself acknowledges the gap and its own inability to close it, and that naming the ground requires no more of an unexplained given than the naturalist has already, of necessity, accepted — only the willingness to call it by a name.

*(Confidence tier. §§1–6 are a review of current physics, with settled results stated plainly and live debates flagged; they carry no theological content and need none. The identification of t = 0 with the first operation of the actualization mechanism is a structural reading, derived from Papers 1 and 3½ and conditional on that framework. The naming of the source as Creator is the interpretive step — the framework's one acknowledged move beyond method — and is marked as such, not presented as a scientific conclusion.)*
...
> *— Georges Lemaître, The Primeval Atom (1946)*
...
The universe had a beginning, hot and dense and finite in the past, and the fact of it is established beyond serious doubt by three independent witnesses. The first fraction of a second is partly charted and, at its earliest edge, walled off by the absence of a theory of quantum gravity. The first instant itself — its cause, its conditions, whether "before" it means anything — lies past where current methods can go, and physics says so. On that gap the scientist and the framework agree completely; they part on one word only. Where the equations name an undetermined or uncaused beginning and fall silent, the series names its source, marks the naming as the single step it is, and carries the consequences forward into the paper that follows. The science is offered whole and unconditioned. The one further step is offered as a step, to be taken or declined.
...
1. **Companion papers**: *Modeling Reality as a Gelfand Triple* (Paper 1); *From the Cogito to the Logos* (Paper 2); *The Constraint Cascade* (Paper 3½); *The Long Ascent* (Paper 5).
...
4. **Penzias, A.A., and Wilson, R.W.** (1965). "A Measurement of Excess Antenna Temperature at 4080 Mc/s." *Astrophysical Journal,* 142, 419–421. [Discovery of the cosmic microwave background.]

5. **Hu, W., and Dodelson, S.** (2002). "Cosmic Microwave Background Anisotropies." *Annual Review of Astronomy and Astrophysics,* 40, 171–216.

6. **Fields, B.D., et al.** (2020). "Big-Bang Nucleosynthesis after Planck." *JCAP,* 03, 010. See also **Fields, B.D.** (2011), "The Primordial Lithium Problem," *Annual Review of Nuclear and Particle Science,* 61, 47–68.

7. **Penrose, R.** (1965). "Gravitational Collapse and Space-Time Singularities." *Physical Review Letters,* 14, 57. **Hawking, S.W., and Penrose, R.** (1970). "The Singularities of Gravitational Collapse and Cosmology." *Proc. R. Soc. Lond. A,* 314, 529. [The classical singularity theorems.]

8. **Guth, A.H.** (1981). "Inflationary universe: A possible solution to the horizon and flatness problems." *Physical Review D,* 23, 347. **Linde, A.** (1982); **Albrecht, A., and Steinhardt, P.J.** (1982). [The inflationary paradigm.]

9. **BICEP/Keck Collaboration** (2021–2025). Constraints on primordial gravitational waves / the tensor-to-scalar ratio from CMB B-mode polarization. [No confirmed primordial B-mode detection; at most a marginal hint.]

10. **DESI Collaboration** (2025). "DESI DR2 Results: Baryon Acoustic Oscillations and Cosmological Constraints." [Preference for evolving dark energy over a cosmological constant, sample-dependent and contested.]

11. **Riess, A.G., et al.** (2024). JWST observations confirming the local Cepheid distance scale and the persistence of the Hubble tension. [The tension deepened, not resolved.]
...
*Cross-reference: [[Modeling Reality as a Gelfand Triple]]; [[From the Cogito to the Logos]]; [[Paper 3 1_2 - The Constraint Cascade|Paper 3½ — The Constraint Cascade]] (the structural descent the beginning initiates, and the three readings gathered); [[Paper 5 - The Long Ascent|Paper 5 — The Long Ascent]] (the material trail from the electroweak vacuum to us)*
